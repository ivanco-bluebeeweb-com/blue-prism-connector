...
-- same pattern as UiPath Connector's / Automation Anywhere Connector's /
MuleSoft Connector's main.py.
"""
...
_LOCAL = ("app", "schemas", "bp_client", "handlers", "panels", "panels_settings")
for _mod in _LOCAL:
