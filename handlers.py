...
async def connect_blue_prism(ctx, params: ConnectBluePrismParams) -> ActionResult:
    ...
    return ActionResult.success(_to_provider_connection(entry), message="Blue Prism estate connected.", summary="Blue prism connected.")
...
async def list_connections(ctx, params: NoParams) -> ActionResult:
    ...
    return ActionResult.success(ProviderConnectionList(title="Connected Blue Prism estates", items=items), summary="Connections listed.")
...
async def disconnect_blue_prism(ctx, params: DisconnectBluePrismParams) -> ActionResult:
    ...
    return ActionResult.success(DeleteResult(id=params.connection_id, title="Disconnected", ok=True), message="Blue Prism estate disconnected.", summary="Blue prism disconnected.")
...
async def list_processes(ctx, params: ListProcessesParams) -> ActionResult:
    ...
    return ActionResult.success(ProcessList(title="Processes", items=items), summary="Processes listed.")
...
async def get_process(ctx, params: GetProcessParams) -> ActionResult:
    ...
    return ActionResult.success(Process(id=str(p.get("id", "")), title=p.get("name", ""), description=p.get("description", "") or "",
                                    is_published=bool(p.get("isPublished", False))), summary="Process retrieved.")
...
async def list_sessions(ctx, params: ListSessionsParams) -> ActionResult:
    ...
    return ActionResult.success(SessionList(title="Sessions", items=items), summary="Sessions listed.")
...
async def start_session(ctx, params: StartSessionParams) -> ActionResult:
    ...
    return ActionResult.success(
        ...
        message=f"Session {session_id} started.", summary="Session start requested."
    )
...
async def stop_session(ctx, params: StopSessionParams) -> ActionResult:
    ...
    return ActionResult.success(
        ...
        message=f"Requested {params.action} for session {params.session_id}.", summary="Session stop requested."
    )
...
async def list_work_queues(ctx, params: ListWorkQueuesParams) -> ActionResult:
    ...
    return ActionResult.success(WorkQueueList(title="Work queues", items=items), summary="Work queues listed.")
...
async def list_queue_items(ctx, params: ListQueueItemsParams) -> ActionResult:
    ...
    return ActionResult.success(QueueItemList(title=f"Queue items -- {params.queue_id}", items=items), summary="Queue items listed.")
...
async def add_queue_item(ctx, params: AddQueueItemParams) -> ActionResult:
    ...
    return ActionResult.success(
        ...
        message=f"Added item to work queue {params.queue_id}.", summary="Queue item created."
    )
...
async def set_queue_item_status(ctx, params: SetQueueItemStatusParams) -> ActionResult:
    ...
    return ActionResult.success(
        ...
        message=f"Queue item {params.item_id} set to {params.status}.", summary="Queue item status updated."
    )
...
async def list_resources(ctx, params: ListResourcesParams) -> ActionResult:
    ...
    return ActionResult.success(ResourceList(title="Runtime resources", items=items), summary="Resources listed.")
...
async def list_credentials(ctx, params: ListCredentialsParams) -> ActionResult:
    ...
    return ActionResult.success(CredentialList(title="Credentials", items=items), summary="Credentials listed.")
...
async def bulk_stop_sessions(ctx, params: BulkSessionIdsParams) -> ActionResult:
    ...
    return ActionResult.success(
        ...
        message=f"{succeeded} succeeded, {failed} failed.", summary="Bulk stop sessions done."
    )
...
async def audit_estate(ctx, params: AuditEstateParams) -> ActionResult:
    ...
    return ActionResult.success(
        ...
        message=f"Audited {len(rows)} resources -- {offline_count} offline, {total_exception_items} exception queue items.", summary="Estate audit ready."
    )
